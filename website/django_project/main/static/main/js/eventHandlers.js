...
import {
  ...
  joinQueue,
  startLocalGame,
} from "/matchmaking/static/matchmaking/js/matchmaking.js";
import {
  changeRender,
  forfeitGame,
  quitGame,
} from "/pong_app/static/pong_app/js/pong.js";
import {
  joinTournament,
  tournamentView,
  updateReadyState,
} from "/tournaments/static/tournaments/js/tournaments.js";
...
const buttonActions = {
  ...
  tournamentUserReadyButton: (event) =>
    updateReadyState(event, window.tournamentWebSocket, "ready"),
  tournamentUserNotReadyButton: (event) =>
    updateReadyState(event, window.tournamentWebSocket, "not_ready"),
...
export function eventHandlers() {
  ...
  document
    ...
    .addEventListener("click", function (event) {
      ...
      const joinTournamentButton = event.target.closest(
        ".joinTournamentButton"
      );
      if (joinTournamentButton) {
        const tournamentId =
          joinTournamentButton.getAttribute("data-tournament-id");
